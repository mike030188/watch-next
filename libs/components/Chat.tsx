...
const Chat = () => {
	...
	const [onlineUsers, setOnlineUsers] = useState<number>(0); // sharli ravishda "4" qib test qilamiz
		...
		socket.onmessage = (msg) => {
			...
			switch (data.event) {
				...
				case 'info':
					...
					break;
				/** yangi client qowilganda uning datalari korinadi **/
				case 'getMessages':
					const list: MessagePayload[] = data.list;
					setMessagesList(list);
					break;
				/** Kimdur mssg yozganda **/
				case 'message':
