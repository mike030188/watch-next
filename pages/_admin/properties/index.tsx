...
const AdminProperties: NextPage = ({ initialInquiry, ...props }: any) => {
	...
	// useQuery orqali allProperties larni Backenddan chaqirib olamiz...
	const {
		...
		variables: { input: propertiesInquiry }, // propertiesInquiry (initialInquiry)= defaultProps dan kelyapti
	...
	const removePropertyHandler = async (id: string) => {
		try {
			if (await sweetConfirmAlert('Are you sure to remove?')) {
				...
				await getAllPropertiesByAdminRefetch({ input: propertiesInquiry }); // retrieve latest datas
			}
