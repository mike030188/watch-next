...
const AdminCommunity: NextPage = ({ initialInquiry, ...props }: any) => {
	...
	/** APOLLO REQUESTS **/
	const [updateBoardArticleByAdmin] = useMutation(UPDATE_BOARD_ARTICLE_BY_ADMIN); // ReactQuery hooks
	const [removeBoardArticleByAdmin] = useMutation(REMOVE_BOARD_ARTICLE_BY_ADMIN);

	// useQuery orqali allBoardArticle listni Backenddan chaqirib olamiz...
	const {
		...
		variables: { input: communityInquiry }, // communityInquiry (initialInquiry)= defaultProps dan kelyapti
